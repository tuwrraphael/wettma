...
namespace Wettma.Migrations
{
    ...
    [Migration("20260629085415_WinnerTeam")]
    partial class WinnerTeam
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wettma.Services.DbModels.WinnerTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("WinnerTeams");
                });

            modelBuilder.Entity("Wettma.Services.DbModels.WinnerTeamBet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("WinnerTeamOddsId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("WinnerTeamOddsId");

                    b.ToTable("WinnerTeamBets");
                });

            modelBuilder.Entity("Wettma.Services.DbModels.WinnerTeamOdds", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Wettma.Services.DbModels.WinnerTeamBet", b =>
                {
                    b.HasOne("Wettma.Services.DbModels.User", "User")
                        .WithMany("WinnerTeamBets")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Wettma.Services.DbModels.WinnerTeamOdds", "WinnerTeamOdds")
                        .WithMany("WinnerTeamBets")
                        .HasForeignKey("WinnerTeamOddsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("User");

                    b.Navigation("WinnerTeamOdds");
                });

            modelBuilder.Entity("Wettma.Services.DbModels.WinnerTeamOdds", b =>
                {
                    b.HasOne("Wettma.Services.DbModels.WinnerTeam", "WinnerTeam")
                        .WithMany("WinnerTeamOdds")
